...
- Confirmed current Project Detail IA
- Integrated Why It Mattered into What Made This Hard
- Integrated Business Impact into Outcomes
- Added semantic redaction rule
- Added GitHub-native execution as preferred path
- Added stale Work-session protection
- Added featured Decision `deliveryBoundary` generic capability
- Added qualitative Outcomes headline/cards/closing generic capability
- Added structured non-image Evidence generic capability
- Added token-saver lazy-reference protocol

## 2026-08-17 v1
- Initial consolidated skill artifact
