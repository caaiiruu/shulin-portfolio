...
const audit=async page=>page.evaluate(()=>{
  ...
  for(const leaf of document.querySelectorAll('.case-study-section *')){
    if(!visible(leaf)||leaf.closest('.evidence-lightbox-v147,[data-interactive-prototype],.decision-visual-v58,.gallery-stage-v45,.gallery-thumbs-v45,.key-intervention-map,.interactive-flow-v195'))continue;
