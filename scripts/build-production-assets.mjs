...
if (content.contentVersion !== "2026-08-11-r151") throw new Error("The active Content SSOT must be r151");
...
if (assetManifest.packageVersion !== "r45" || assetManifest.contentVersion !== "2026-08-11-r151") {
