...
if (content.contentVersion !== "2026-08-19-r164.8") throw new Error("The active Content SSOT must be r164.8");
...
if (assetManifest.packageVersion !== "r45" || assetManifest.contentVersion !== "2026-08-19-r164.8") {
  throw new Error("The active Asset Manifest must be r45 aligned to Content r164.8");
}
