...
fail(createHash("sha256").update(contentBytes).digest("hex") === "df31cffcf2dba2bef0057c6cb4e7859c2578e6f27fad665a54c35b61b9504dea", "Content r146 SHA changed");
...
fail(slots.length === 31, "Runtime slot count must be 31");
