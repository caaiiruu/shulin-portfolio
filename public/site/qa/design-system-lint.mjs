...
if (!projectDetail.includes(".ownership-grid-v45>article{padding:0") || !projectDetail.includes("background:transparent;border-radius:0")) errors.push("ProjectDetailOverview: ownership must use typography and dividers, not page-level cards");
