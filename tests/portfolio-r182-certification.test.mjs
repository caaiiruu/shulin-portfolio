...
test('R182.5 binds one approved 16:9 Lead Visual to every Primary card and detail slot',()=>{
  const expected={
    voucher:['voucher-hero-incentive-journey-public-v1','voucher-lead-visual-incentive-ecosystem-public-v1.jpg','f5331961c10a480bd19b084d36503d03acc0cc1d4f92596e34996e6cec14c109'],
    'voucher-center':['voucher-center-hero-centralised-discovery-public-v1','voucher-center-lead-visual-claim-journey-public-v1.jpg','e08f17370fa7fab0355548ff29f9e09263ea6a2569d4c77f163ca272acd9a111'],
    'game-center':['gamecenter-hero-shipped-before-after-public-v1','game-center-lead-visual-multi-game-discovery-public-v1.jpg','7c1034a0a675058893fd09003e221ca2c1970e7c7f0d20372b5e644938e67c23'],
    dbs:['dbs-project-card-primary-01','dbs-lead-visual-exception-and-risk-workbench-public-v1.jpg','660a32a141cafa66b546af26fa2f24505961f0a828d944dbb15bb58f3e2700cf'],
    booking:['booking-hero-connected-booking-public-v1','booking-connected-trip-lead-visual-timeline-experience-public-v1.jpg','c04815c8513afdb8103e1e3b075ecb90f088f1bb979c624e47fc6b8ebef05e44'],
    ...
    payment:['payment-hero-unified-checkout-public-v1','payment-lead-visual-app-and-sco-checkout-public-v1.jpg','4b54701970ceacb2b5f814053798281ed7f677c2a721bdb74a580dc6ab093e39'],
    'cathay-sit-online-account-opening':['cathay-sit-hero-final-flow-public-v1','cathay-online-account-opening-lead-visual-end-to-end-flow-public-v1.jpg','758e3fdd0bfb288f8395262d1752508cf1f2b54bfbfb48498a16147ae137accd'],
    ...
    'cathay-mortgage-assistant':['cathay-mortgage-hero-consultation-public-v1','cathay-mortgage-assistant-lead-visual-consultation-system-public-v1.jpg','46747ae851aaedd903b415fbfc479b1eeb29a79b9c255d8b1787eba16ea6ce70'],
    'cathay-sit-review-remediation-operations':['cathay-review-research-operating-baseline-public-v1','cathay-review-remediation-lead-visual-remediation-operating-model-public-v1.jpg','14124e5ca4923c22ad8903a76886b51f6b32b0e1d0c02a5d188c093ee4e456e4'],
    'ctbc-mortgage-self-service-app':['ctbc-mortgage-hero-final-flow-public-v1','ctbc-mortgage-self-service-lead-visual-service-architecture-public-v1.jpg','53ab5712e3b41a072873059f4919861df6aaf114a07ae3c0774e86e95580261c'],
  ...
  const humanApprovedProjectCardLeads=new Set(['voucher','voucher-center','game-center','dbs','booking','payment','cathay-sit-online-account-opening','cathay-mortgage-assistant','cathay-sit-review-remediation-operations','ctbc-mortgage-self-service-app']);
  for(const [projectId,[assetId,filename,sha256]] of Object.entries(expected)){
    ...
    const expectedGeometry=humanApprovedProjectCardLeads.has(projectId)?{aspectRatio:'16:9',width:1672,height:941}:{aspectRatio:'16:9',width:2048,height:1152};
...
test('R183.4E keeps Payment frozen and canonicalises the latest Human-approved Voucher truth',()=>{
  ...
  assert.deepEqual([lead.aspectRatio,lead.width,lead.height,lead.sha256],['16:9',1672,941,'f5331961c10a480bd19b084d36503d03acc0cc1d4f92596e34996e6cec14c109']);
