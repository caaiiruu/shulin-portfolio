...
test('Daily Hours is a registry-backed Work projection without becoming legacy project 14',()=>{
  ...
  assert.deepEqual(route.workProjection,{title:'Daily Hours',cardTitle:'Daily Hours — A decision workspace for freelance capacity, pricing, and revenue',type:'0→1 Product',summary:'A freelance project-economics and decision workspace.',route:'/work/daily-hours',period:'2026',filterIds:['zero'],coverAssetId:'daily-hours-hero-static',searchIndexV2:{contentType:'project',canonicalId:'daily-hours',aliases:{en:['Daily Hours']},problemTags:{en:['freelance operations','project economics','decision workspace','0→1 product']},capabilityTags:{en:['project health','project estimation','workload planning']},intentIds:['launch-zero-to-one-product']}});
