...
for (const viewport of viewports) {
  ...
  if(taishinPresentation.atAGlance!=="Co-led UX definition of fragmented P2P marketplace flows, using 30 interviews to align bank and vendor on a shared delivery model.")failures.push(`${viewport.name} Taishin At a Glance mismatch`);
