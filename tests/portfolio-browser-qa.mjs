...
for (const viewport of viewports) {
  ...
  if(taishinPresentation.atAGlance!=="Co-led research and UX definition of a P2P marketplace, turning 30 interviews into a shared transaction model and delivery specifications across the bank and software vendor.")failures.push(`${viewport.name} Taishin At a Glance mismatch`);
