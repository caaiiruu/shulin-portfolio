...
for (const viewport of viewports) {
  ...
  if(cathayOaPresentation.outcomeIntro!=="One aligned account-opening model and a development-ready specification set."||cathayOaPresentation.outcomeChangeCount||!cathayOaPresentation.outcomeGridAligned||cathayOaPresentation.outcomeLabelWeights.some(weight=>weight<700))failures.push(`${viewport.name} Cathay OA Payment-parity Outcome hierarchy failed: ${JSON.stringify(cathayOaPresentation)}`);
