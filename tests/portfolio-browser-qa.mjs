...
for (const viewport of viewports) {
  ...
  if(taishinPresentation.atAGlance!=="Co-led UX definition of fragmented P2P marketplace flows, turning 30 interviews into a shared bank–vendor delivery model.")failures.push(`${viewport.name} Taishin At a Glance mismatch`);
