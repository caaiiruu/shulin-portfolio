...
for (const viewport of viewports) {
  ...
  if(viewport.width===1419&&(bookingCertification.insight.titleLines>3||bookingCertification.insight.title.width<600))failures.push(`${viewport.name} Booking Core System Insight headline width failed: ${JSON.stringify(bookingCertification.insight)}`);
