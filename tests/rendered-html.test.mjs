...
test("R170 projects Taishin P2P through one recruiter-first owner without legacy or claim leakage",()=>{
  ...
  assert.equal(project.atAGlance.en,"Co-led P2P marketplace research and UX definition, turning 30 interviews and fragmented transaction states into one shared bank–vendor delivery model.");
