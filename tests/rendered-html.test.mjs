...
test("R170 projects Taishin P2P through one recruiter-first owner without legacy or claim leakage",()=>{
  ...
  assert.equal(project.atAGlance.en,"Co-led research and UX definition of a P2P marketplace, turning 30 interviews into a shared transaction model and delivery specifications across the bank and software vendor.");
