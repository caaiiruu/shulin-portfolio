...
test("keeps complete project decision content in the SSOT renderer", () => {
  ...
  assert.equal(ssot.contentVersion, "2026-08-20-r164.9c");
  assert.equal(Object.keys(ssot.projects).length, 13);
